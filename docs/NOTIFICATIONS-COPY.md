...
| Мова | Title | Body |
|---|---|---|
| uk | Повний доступ ще {days} дні | Твій рівень {level} і серія {streak} з тобою. Ще 3 дні все відкрито. |
| ru | Полный доступ ещё {days} дня | Твой уровень {level} и серия {streak} с тобой. Ещё 3 дня всё открыто. |
| en | {days} days of full access left | Your level {level} and streak {streak} are yours. 3 days still fully open. |
| pl | Pełny dostęp jeszcze {days} dni | Twój poziom {level} i seria {streak} są z tobą. Jeszcze 3 dni wszystko otwarte. |
...
Той самий зміст, довший формат. Одна CTA-кнопка. Приклад для стану C (uk):
...
ru / en / pl — дослівні відповідники за таблицями вище; локалізувати через ту саму
систему, що й решта листів (`send-winback`).
