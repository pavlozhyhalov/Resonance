...
- **Support URL:** `youresonance.com/#/support` (окрема сторінка `/support` вже є, 7 мов — контакт, час відповіді, лінк на політику, FAQ).
- **Marketing URL (опц.):** youresonance.com.
- **Privacy Policy URL:** `youresonance.com/#/privacy` (сторінка вже є, 7 мов).

## Age Rating (оновлена система Apple 2025-2026: 4+/9+/13+/16+/18+)

Заповнюється в App Store Connect → App Information → Age Ratings.
Очікуваний чесний результат: 9+ або 13+ (НЕ намагатись втиснутись у 4+).

| Блок анкети | Відповідь | Обґрунтування |
|---|---|---|
| In-App Controls (батьківський контроль) | Немає | Застосунок не в Kids Category |
| Capabilities — чат/AI | ТАК, є AI-чат | AI-наставник; чату між користувачами немає |
| Capabilities — необмежений веб-доступ | Немає | Музика через diplinks у зовнішні застосунки, вбудованого браузера немає |
| Capabilities — UGC / соціальні функції | Немає | Немає контенту інших користувачів; демо-імена спільноти — фіксований демо-контент |
| Medical or Wellness Topics | ТАК, є wellness-контент | Дихальні практики й холодові практики з фізіологічним ефектом і медичними дисклеймерами. Не занижувати цю відповідь |
| Violent Themes | Немає | — |
| Alcohol / Tobacco / Drugs | Немає | — |
| Gambling / Contests | Немає | Немає механік випадковості чи ставок |
| Profanity | Немає | Тексти пройшли мовну вичитку |
| Horror / Fear Themes | Немає | — |

Примітка: точні формулювання питань видно тільки всередині App Store Connect —
звіряти по суті, не копіювати сліпо.
